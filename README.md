...
This is a C++20 library providing color features like a RGBA color class and a few color constants already defined.
...
int main()
{
    ...
    std::cout << tbaricault::uniconvert::convert<tbaricault::colors::Color, std::string>(red) << std::endl;

    tbaricault::colors::Color green = 0xff00ff00;
    std::cout << tbaricault::uniconvert::convert<tbaricault::colors::Color, std::string>(green) << std::endl;

    tbaricault::colors::Color blue = tbaricault::uniconvert::convert<std::string, tbaricault::colors::Color>("#0000ff");
    std::cout << tbaricault::uniconvert::convert<tbaricault::colors::Color, std::string>(blue) << std::endl;
