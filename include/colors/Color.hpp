...
namespace tbaricault::uniconvert
{
    ...
    /**
     * @brief Utils class to convert a string to color
     */
    template<>
    struct Converter<std::string, tbaricault::colors::Color>
    {
         ...
         */
        tbaricault::colors::Color operator()(const std::string& value) const;

    };


    /**
     * @brief Utils class to convert a color to string
     */
    template<>
    struct Converter<tbaricault::colors::Color, std::string>
    {

        /**
         * @brief Converts a color to its string representation
         * 
         * @param value Color to convert
         * 
         * @return String representation
         */
        std::string operator()(const tbaricault::colors::Color& value) const;
